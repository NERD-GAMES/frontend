...
function Board({ players, cardsInBoard, size, onSelected }: Props) {
  ...
  return (
    <TableContainer component={Paper} style={{ maxWidth: "98vw" }}>
      <Table size="small" style={{
        backgroundImage: "url(https://images.tcdn.com.br/img/img_prod/607564/mural_de_parede_montanhas_1554_2_20180126155300.jpg)",
      }}>
        <TableBody>
          {heigthList.map(y => {
            return (
